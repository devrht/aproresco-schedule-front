 ...
 */
    const handleChange = (event, status) =>{
        ...
        if (type === "date") {
            ...
            const toDurationStr = `${duration.getMonth()+1}%2F${duration.getDay()}%2F${duration.getFullYear()}%20${duration.getHours()}:${duration.getMinutes()}:00 -0500`
            ...
            localStorage.setItem(`to${labelDuration}`, tmp.join('%20'));
        } 
